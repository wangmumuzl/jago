...
public class GamesFrame extends CloseFrame implements CloseListener
{
	...
	{
		System.out.println("GamesFrame.refresh:161");
		L = new ListClass();
		LNumber = 0;
		T.setText(Global.resourceString("Load"));
		if (GD != null) GD.unchain();
	...
	{
		System.out.println("GamesFrame.receive");
		if (Closed) return;
	...
	{
		System.out.println("GamesFrame.allsended");
		if (GD != null) GD.unchain();
		if (Closed) return;
