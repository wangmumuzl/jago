...
public class RoadTable {
	...
	private int[] scoreOfMyRoad = {1,10,15,350,250,10000};
	private int[] scoreOfEnemyRoad = {1,10,15,35,25,10000};
	...
	//按黑白子个数划分的路表：包含0个至6个黑�?, 0个至6个白子的路；�?称为黑白路表
	//例如�? playerRoads[3][2]表示含有3个黑子，2个白子的�?
